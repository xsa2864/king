                    ...
                    <table border="0">
                        ...
                        foreach($itemList as $item)
                        {
                            ...
                            <td class="sort_shop cf align_left" style="text-align:left;">
                                ...
                                <span class="sp2" style="padding-left: 10px;">'.$item->title.'<br><label id="price">￥'.$item->attr_price.'</label><br>积分:'.$item->attr_jifen.'<br>库存:'.$item->attr_stock.'</span>
                            </td>                              
                            <td>'.item_ext::get_sell_num($item->id).'</td>
                            ...
                            <td class="revise">
                                ...
                                <a href="'.input::site('admin/item/see/'.$item->id).'">查看</a>
                                <a href="'.input::site('admin/item/edit/'.$item->id).'">复制地址</a>
                                <a target="blank" href="'.input::site('admin/item/qrcode?id='.$item->id).'">二维码</a>
                            </td>
                        </tr>';
                        }
                        ?>
...
<script type="text/javascript">
    ...
    function upCheckedItem() {
        if($("input:checkbox[name='checkbox']:checked").attr('name') == undefined){
            alert('请选择商品!');
            return false;
        }
