        ...
        <div class="right">
            ...
            <div class="export add_fz">
                <dl class="cf ma20">
                    ...
                    <dd>
                        <input id="inputGroupName" class="inp185" type="text" /></dd>
                </dl>
                <dl class="cf ma20  textarea_width">
                    <dt><em class="asterisk">*</em>说明：</dt>
                    <dd>
                        <textarea id="other" class="width" name=""></textarea></dd>
                </dl>
                            ...
                            <ul class="cf">
                                ...
                                foreach($tree as $item)
                                {
                                    ...
                                    <a class="h1" style="cursor:pointer;">
                                        <i class="i2"></i>
                                        <input name="modId" modId="'.$item->id.'" type="checkbox" class="check_all">'.$item->modName.'
                                    </a>
                                    ...
                                    if($item->child)
                                    {
                                        foreach($item->child as $ch)
                                        {
                                            ...
                                            <input name="modId" modId="'.$ch->id.'" type="checkbox" />'.$ch->modName.'</a>';
                                        }
                                    }
                                    echo '</div>
                                </li>';
...
<script type="text/javascript">
    ...
    function btnSubmit() {
        ...
        $.post("<?php echo input::site('admin/group/save'); ?>", { 'newGroupName': newGroupName, 'tree': c, 'other': other },
                    function (data) {
                        var da = eval('('+data+')');
                        if (da.success == 1) {
